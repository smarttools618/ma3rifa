    ...
    >
      <div className="max-w-3xl mx-auto">
            ...
            {userLoading ? (
              ...
              <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                ...
                <div className="sm:col-span-1">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{getGradeName(userDetails?.grade)}</dd>
                </div>
                <div className="sm:col-span-1">
                  <dt className="text-sm font-medium text-gray-500">نوع الاشتراك</dt>
                  <dd className="mt-1 text-sm text-gray-900">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${userDetails?.plan === 'paid' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                      {getPlanName(userDetails?.plan)}
                    </span>
                  </dd>
                </div>
                {userDetails?.plan === 'paid' && userDetails?.subscription_end && (
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500">تاريخ انتهاء الاشتراك</dt>
                    <dd className="mt-1 text-sm text-gray-900">
                      {new Date(userDetails.subscription_end).toLocaleDateString('ar-EG')}
                    </dd>
                  </div>
                )}
              </dl>
        ...
        {userDetails?.plan === 'free' && (
          <div className="bg-white shadow rounded-lg glass-card overflow-hidden mb-8">
            <div className="px-6 py-5 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">ترقية الحساب</h2>
            </div>
            <div className="px-6 py-5">
              <div className="text-center">
                <h3 className="text-lg font-medium text-gray-900 mb-2">استمتع بمزايا الاشتراك المدفوع</h3>
                <p className="text-sm text-gray-600 mb-4">
                  قم بترقية حسابك للوصول إلى جميع الملفات والمحتويات التعليمية بدون قيود
                </p>
                <a
                  href="/dashboard"
